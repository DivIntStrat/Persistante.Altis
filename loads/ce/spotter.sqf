...
_unit addWeapon "R3F_HK417M";
_unit addPrimaryWeaponItem "R3F_J4";
_unit addPrimaryWeaponItem "R3F_20Rnd_762x51_HK417";
...
for "_i" from 1 to 10 do {_unit addItemToBackpack "R3F_20Rnd_762x51_HK417";};
